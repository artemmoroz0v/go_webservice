...
6. Финальные таблицы базы данных после заполнения в рамках пояснения своего проекта в этом README-файле я прикреплю в формате .csv в папку ***final_results***.
...
*Забыл на диаграмме в базу данных транзакций добавить поле comment.
