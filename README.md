...
Данный HTTP API микросервис принимает JSON и отвечает в формате JSON. Для разработки микросервиса был использован фреймворк ***gin*** и объектно-реляционная СУБД ***PostgreSQL***.
